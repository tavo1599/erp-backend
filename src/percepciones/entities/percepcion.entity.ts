...
import { PercepcionDetalle } from './percepcion-detalle.entity';
...
export class Percepcion {
  ...
  // 01 = 2% (venta interna), 02 = 1% (combustible), 03 = 0.5% (tasa especial)
  ...
  @OneToMany(() => PercepcionDetalle, (detalle) => detalle.percepcion, {
    cascade: true,
  })
